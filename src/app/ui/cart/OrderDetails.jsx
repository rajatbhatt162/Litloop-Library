      ...
      {bookToBuy.length + bookToRent.length > 0 ? (
        <>
          <ul className="pb-4 text-md">
            <li>
              Buying {bookToBuy.length} book(s) for{" "}
              <strong>{priceForBuy} INR </strong>
            </li>
            <li>
              Renting {bookToRent.length} book(s) for{" "}
              <strong>{priceForRent} INR</strong>
            </li>
            <li className="pt-2">
              Delivery Charge: <strong>{deliveryCharge} INR</strong>
            </li>
          </ul>
          <div className="border"></div>
          <div className="pt-4">
            <p className="text-xl">Total Amount to Pay</p>
            <p className="text-center p-4 text-5xl font-semibold">
              {priceForBuy + priceForRent + deliveryCharge} INR
            </p>
          </div>
        </>
      ) : (
